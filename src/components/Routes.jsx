...
const AppRoutes = ({ isLoggedIn, role, setIsLoggedIn, userId }) => (
  <Routes>
    {/* Public Routes */}
    <Route
      path="/"
    ...
    <Route
      ...
      element={isLoggedIn ? <VendorDashboard /> : <Navigate to="/VendorLogin" />}
    />
    <Route
      path="/animals"
    ...
    <Route
      path="/cart"
      element={
        isLoggedIn ? <CartPage userId={userId} /> : <Navigate to="/login" />
      }
    />
    <Route
      path="/cart/:cartId"  // Dynamic route for cart with specific ID
      element={
        isLoggedIn ? <CartPage userId={userId} /> : <Navigate to="/login" />
      }
    />
